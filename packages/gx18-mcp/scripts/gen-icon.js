...
const hasSrcPng = fs.existsSync(srcPngPath)
const faviconData = hasSrcPng ? fs.readFileSync(srcPngPath).toString('base64') : ico.toString('base64')
const faviconMime = hasSrcPng ? 'image/png' : 'image/x-icon'
const ts = [
  '// Auto-generated by scripts/gen-icon.js — do not edit manually',
  `export const FAVICON_DATA = 'data:${faviconMime};base64,${faviconData}'`,
  `export const FAVICON_MIME = '${faviconMime}'`,
  '',
].join('\n')
